...
public class init {
  public static void main(String[] args) {
    ...
    if (loader.runningFromJar()) {
      System.out.println("Extracting impl ementation jar...");
      ...
      //System.load(new File(binlib,"libleveldb.so").getAbsolutePath());
    ...
    try {
      Class<?> c = Class.forName("com.hexdata.hexbase.Hexbase",true,loader);
