...
public class Loader extends URLClassLoader {
  private final static Loader _instance  = new Loader(Thread.currentThread().getContextClassLoader());
  private final static String _os;
  private final static String _ext;
  ...
  static {
    ...
    if (osName.startsWith("Windows")) {
      ...
      // hope the osName is usable as is...
      _ext = "so";
    }
    _os = osName + arch;
  }
  ...
  ClassLoader _parent;
  ZipFile _ownJar; // own jar file, null if not running from a jar file
  File _binlib;
