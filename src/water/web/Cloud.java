...
public class Cloud extends H2OPage {
  ...
  private final String html =
    ...
    + "<thead class=''><tr><th>Local Nodes</th><th>CPUs</th><th>Local Keys</th><th>Mem Cached</th><th>FreeMem</th><th>TotalMem</th><th>MaxMem</th><th>FreeDisk</th><th>MaxDisk</th><th>CPU Utilization</th><th>Threads</th><th>CPU Load (1min)</th><th>CPU Load (5min)</th><th>CPU Load (15min)</th><th>FJ Task Depth</th><th>Type</th></tr></thead>"
    + "<tbody>"
    + "%tableRow{"
    + "  <tr>"
