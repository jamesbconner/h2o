...
(jde-set-variables
 ...
 '(jde-run-option-application-args (quote ("-mainClass" "org.junit.runner.JUnitCore" "test.KVTest" "test.AutoSerialTest" "test.DatasetCornerCasesTest" "test.AppendKeyTest" "test.RandomForestTest" "test.ExprTest" "test.KeyToString" "test.RStringTest" "test.ParserTest" "test.MinorityClassTest")))
