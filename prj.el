...
(jde-set-variables
 ...
 '(jde-compile-option-classpath (quote ("./build/classes" "./lib/sigar/sigar.jar" "./lib/hadoop/1.0.0/hadoop-core-1.0.0.jar" "./lib/apache/commons-logging-1.1.1.jar" "./lib/junit/junit-4.11.jar" "./lib/apache/guava-12.0.1.jar" "./lib/gson/gson-2.2.2.jar" "./lib/apache/commons-codec-1.3.jar" "./lib/jama/Jama.jar" "./lib/asm/asm-all-4.0.jar")))
